...
do
    ...
    ssh $USER@fa22-cs425-220$val.cs.illinois.edu "cd mp4/IDunno; exec -a coordinator python3 coordinator.py" &
    sleep 0.5
done 
...
do
    ...
    ssh $USER@fa22-cs425-220$val.cs.illinois.edu "cd mp4/IDunno; exec -a workers python3 worker.py" &
    sleep 0.5
done
echo start worker on VM10...
ssh $USER@fa22-cs425-2210.cs.illinois.edu "cd mp4/IDunno; exec -a workers python3 worker.py" &
echo VM10 Updated
