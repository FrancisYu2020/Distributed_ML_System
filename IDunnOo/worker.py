    ...
    def train_model(self, model_name, train_data) -> bool:
        ...
        while True:
            try:
                ...
                self.rpc_client.connect(
                    "tcp://127.0.0.1:{}".format(LOCAL_SCHEDULER_PORT))
                model = self.rpc_client.load_model(model_name)
                break
            except Exception as e:
                logging.error(
                    "Train: Problem happens when load model: ".format(str(e)))
                self.__sleep()
        ...
        while True:
            try:
                ...
                logging.error(
                    "Train: Problem happens when load data: ".format(str(e)))
                self.__sleep()
        ...
        while True:
            try:
                ...
                logging.error(
                    "Train: Problem happens when save model: ".format(str(e)))
                self.__sleep()
    ...
    def predict(self, model_name, data) -> bool:
        ...
        while True:
            try:
                ...
                logging.error(
                    "Predict: Problem happens when load model: ".format(str(e)))
                self.__sleep()
        ...
        while True:
            try:
                ...
                logging.error(
                    "Predict: Problem happens when load data: ".format(str(e)))
                self.__sleep()
        ...
        while True:
            try:
                ...
                logging.error(
                    "Predict: Problem happens when utilize model to predict: ".format(str(e)))
                self.__sleep()
